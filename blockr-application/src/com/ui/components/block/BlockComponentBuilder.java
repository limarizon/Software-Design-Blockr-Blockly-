...
public class BlockComponentBuilder {
    ...
    private final StatementListBlock programDefinition;
    ...
    public BlockComponentBuilder(StatementListBlock programDefinition, UiMediator mediator) {
        ...
        for(StatementBlock statementBlock : programDefinition.getStatements() ){
            if(! statementBlock.isControlFlow()){
                PaletteStatementBlockComponent blockComponent = new PaletteStatementBlockComponent(statementBlock, mediator, rootPos);
